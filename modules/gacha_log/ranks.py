...
class GachaLogRanks:
    ...
    ITEM_LIST_MAP = {
        ...
        "常驻武器祈愿": GachaLogTypeEnum.DEFAULT_WEAPON,
    }
    ITEM_LIST_MAP_REV = {v: k for k, v in ITEM_LIST_MAP.items()}
    BANNER_TYPE_MAP = {
        "角色祈愿": MCBannerType.CHARACTER,
        "武器祈愿": MCBannerType.WEAPON,
        "常驻祈愿": MCBannerType.STANDARD,
        "常驻武器祈愿": MCBannerType.STANDARD_WEAPON,
    }
    SCORE_TYPE_MAP = {
