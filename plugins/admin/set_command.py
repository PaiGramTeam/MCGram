...
class SetCommandPlugin(Plugin):
    ...
    async def set_command(self, update: "Update", context: "ContextTypes.DEFAULT_TYPE"):
        ...
        user_command = [
            ...
            # # gacha_log 相关
            BotCommand("summon_log", "查看抽卡记录"),
            BotCommand("summon_log_import", "导入抽卡记录"),
            BotCommand("summon_log_export", "导出抽卡记录"),
            BotCommand("summon_log_delete", "删除抽卡记录"),
            BotCommand("summon_log_online_view", "调频记录在线浏览"),
            BotCommand("summon_log_rank", "抽卡排行榜"),
            BotCommand("summon_waiting_list", "未复刻列表"),
        ...
        admin_command = [
            ...
            BotCommand("summon_log_rank_recount", "重新统计抽卡排行榜"),
        ]
