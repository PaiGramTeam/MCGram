...
class WishLogRankPlugin(Plugin):
    ...
    TYPES = [
        ...
        ("常驻武器-总抽数", GachaLogTypeEnum.DEFAULT_WEAPON, GachaLogQueryTypeEnum.TOTAL),
        ("常驻武器-五星平均", GachaLogTypeEnum.DEFAULT_WEAPON, GachaLogQueryTypeEnum.FIVE_STAR_AVG),
    ]
    ...
    @handler.command("summon_log_rank", block=False)
