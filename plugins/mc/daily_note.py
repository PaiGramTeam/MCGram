...
class DailyNotePlugin(Plugin):
    ...
    async def _get_daily_note(self, client: "MCClient") -> RenderResult:
        ...
        render_data = {
            ...
            "current_reserve_stamina": daily_info.storeEnergyData.cur,
            "max_reserve_stamina": daily_info.storeEnergyData.total,
            "liveness_unlock": daily_info.livenessData is not None,
            "remaining_resin_discounts": daily_info.weeklyData.cur,
            "max_resin_discounts": daily_info.weeklyData.total,
